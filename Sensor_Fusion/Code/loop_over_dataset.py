...
if configs_det.use_labels_as_objects:
    print("Using ground truth → skipping model loading")
    model_det = None
else:
...
exec_data = []
exec_detection = ['detect_objects','validate_object_labels',
...
if 'show_detection_performance' in exec_list:
    ##eval.compute_performance_stats(det_performance_all, configs_det) previous
