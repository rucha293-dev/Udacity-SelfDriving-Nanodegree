...
confirmed_threshold = 0.6 # track score threshold to switch from 'tentative' to 'confirmed'
delete_threshold = 0.4 # track score threshold to delete confirmed tracks
...
gating_threshold = 0.9999 #0.995 # percentage of correct measurements that shall lie inside gate
...
sigma_cam_i = 5 # measurement noise standard deviation for image i coordinate#5
sigma_cam_j = 5 # measurement noise standard deviation for image j coordinate#5intial
